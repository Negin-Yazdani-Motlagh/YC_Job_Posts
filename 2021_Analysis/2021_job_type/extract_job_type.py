...
def main():
    # Load posts
    with open("2021_Analysis/2021_job_posts.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    posts = data["YC"]["2021"]["comments"]
    ...
    output_file = Path("2021_Analysis/2021_job_type/2021_job_type_details.xlsx")
