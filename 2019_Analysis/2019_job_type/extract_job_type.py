...
JOB_TYPE_KEYWORDS = [
    ...
    "Relocation required", "Relocation assistance", "Temporary remote"
]
...
def main():
    # Load posts
    with open("2019_Analysis/2019_job_posts.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    posts = data["YC"]["2019"]["comments"]
    ...
    output_file = Path("2019_Analysis/2019_job_type/2019_job_type_details.xlsx")
