...
def main():
    # Load posts
    with open("2023_Analysis/2023_job_posts.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    posts = data["YC"]["2023"]["comments"]
    ...
    output_file = Path("2023_Analysis/2023_job_type/2023_job_type_details.xlsx")
