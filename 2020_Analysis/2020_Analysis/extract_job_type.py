...
def main():
    # Load posts
    with open("2020_Analysis/2020_job_posts.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    posts = data["YC"]["2020"]["comments"]
    ...
    output_file = Path("2020_Analysis/2020_job_type/2020_job_type_details.xlsx")
