...
def main():
    # Load posts
    with open("2017_Analysis/2017_job_posts.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    posts = data["YC"]["2017"]["comments"]
    ...
    output_file = Path("2017_Analysis/2017_job_type/2017_job_type_details.xlsx")
